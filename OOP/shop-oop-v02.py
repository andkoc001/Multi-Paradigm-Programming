...
def display_menu(self):
    ...
    while True:  # this is a 'forever' loop, unless interupted (break)
        ...
        if (choice == "1"):
            print("in shop_menu option 1 ")  # for testing - ok
            # print_shop(shop)
            # display_menu()

        elif (choice == "2"):
            print("in shop_menu option 2 ")  # for testing - ok
            ...
            print("in shop_menu option 3 ")  # for testing - ok
            ...
            print("in shop_menu option 4 ")  # for testing - ok
            ...
            print("in shop_menu option 5 ")  # for testing - ok
            # Welcoming message
